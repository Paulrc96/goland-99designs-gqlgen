...
func (l *PostLoader) Load(key int) ([]*model.Post, error) {
...
func (l *PostLoader) LoadThunk(key int) func() ([]*model.Post, error) {
	l.mu.Lock()
...
func (l *PostLoader) LoadAll(keys []int) ([][]*model.Post, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *PostLoader) LoadAllThunk(keys []int) func() ([][]*model.Post, []error) {
	results := make([]func() ([]*model.Post, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *PostLoader) Prime(key int, value []*model.Post) bool {
	l.mu.Lock()
	var found bool
...
func (l *PostLoader) Clear(key int) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *PostLoader) unsafeSet(key int, value []*model.Post) {
	if l.cache == nil {
...
func (b *postLoaderBatch) keyIndex(l *PostLoader, key int) int {
